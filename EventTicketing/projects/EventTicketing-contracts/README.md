...
By default the template creates a single `HelloWorld` contract under event_ticketing folder in the `smart_contracts` directory. To add a new contract:
